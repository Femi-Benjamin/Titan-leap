    ...
    <div className="md:min-h-screen bg-gradient-to-t from-[#160043] to-[#4C12BF] py-8">
      <div className="xl:px-22 md:px-10 px-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-16 gap-6 mb-16">
          ...
          <div
            className={`group bg-gradient-to-t from-purple-900 to-[#FFFFFF] p-0.5 rounded-2xl hover:bg-gradient-to-t 
          hover:from-[#FED65E] hover:to-[#FED65E] transition-all ${clickedCard === "Content Creation" ? "bg-gradient-to-t from-[#FED65E] to-[#FED65E]" : ""}`}
            onMouseEnter={() => handleCardHover("Content Creation")}
            onMouseLeave={handleCardLeave}
          ...
          >
            <div className="rounded-2xl p-6 text-center relative h-full bg-[#4C12BF]">
              {/* Default State */}
              <div className={`transition-opacity duration-700 ${clickedCard === "Content Creation" ? "opacity-0" : "group-hover:opacity-0"}`}>
                <div className="flex justify-center mb-6">
                  <img
                    className=""
                    src={content || "/placeholder.svg"}
              ...
              {/* HOVER STATE */}
              <div
                className={`absolute inset-0 px-6 py-3 transition-opacity duration-700 
              rounded-2xl bg-gradient-to-t from-[#160043] to-[#4C12BF] ${clickedCard === "Content Creation" ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto"}`}
              >
                <div className="flex justify-center mb6 xlmb-10 ">
                  <img
                    className="w-16 h-16"
          ...
          <div
            className={`group bg-gradient-to-t from-purple-900 to-[#FFFFFF] p-0.5 rounded-2xl hover:bg-gradient-to-t 
          hover:from-[#FED65E] hover:to-[#FED65E] transition-all ${clickedCard === "Social Media Management" ? "bg-gradient-to-t from-[#FED65E] to-[#FED65E]" : ""}`}
            onMouseEnter={() => handleCardHover("Social Media Management")}
            onMouseLeave={handleCardLeave}
          ...
          >
            <div className="rounded-2xl p-6 text-center relative h-full bg-[#4C12BF]">
              {/* Default State */}
              <div className={`transition-opacity duration-700 ${clickedCard === "Social Media Management" ? "opacity-0" : "group-hover:opacity-0"}`}>
                <div className="flex justify-center mb-6">
                  <img
                    className=""
                    src={Frame || "/placeholder.svg"}
              ...
              <div
                className={`absolute inset-0 px-6 py-3 transition-opacity duration-700 
              rounded-2xl bg-gradient-to-t from-[#160043] to-[#4C12BF] ${clickedCard === "Social Media Management" ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto"}`}
              >
                <div className="flex justify-center">
                  <img
                    className="w-12 h-12"
          ...
          <div
            className={`group bg-gradient-to-t from-purple-900 to-[#FFFFFF] p-0.5 rounded-2xl hover:bg-gradient-to-t 
          hover:from-[#FED65E] hover:to-[#FED65E] transition-all ${clickedCard === "Ads & Search Engine" ? "bg-gradient-to-t from-[#FED65E] to-[#FED65E]" : ""}`}
            onMouseEnter={() => handleCardHover("Ads & Search Engine")}
            onMouseLeave={handleCardLeave}
          ...
          >
            <div className="rounded-2xl p-6 text-center relative h-full bg-[#4C12BF]">
              {/* Default State */}
              <div className={`transition-opacity duration-700 ${clickedCard === "Ads & Search Engine" ? "opacity-0" : "group-hover:opacity-0"}`}>
                <div className="flex justify-center mb-6">
                  <img
                    className=""
                    src={Frame || "/placeholder.svg"}
              ...
              <div
                className={`absolute inset-0 px-6 py-3 transition-opacity duration-700 
              rounded-2xl bg-gradient-to-t from-[#160043] to-[#4C12BF] ${clickedCard === "Ads & Search Engine" ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto"}`}
              >
                <div className="flex justify-center mb-6xl:mb-10 ">
                  <img
                    className="w-16 h-16"
          ...
          <div
            className={`group bg-gradient-to-t from-purple-900 to-[#FFFFFF] p-0.5 rounded-2xl hover:bg-gradient-to-t 
          hover:from-[#FED65E] hover:to-[#FED65E] transition-all ${clickedCard === "AI Automation" ? "bg-gradient-to-t from-[#FED65E] to-[#FED65E]" : ""}`}
            onMouseEnter={() => handleCardHover("AI Automation")}
            onMouseLeave={handleCardLeave}
          ...
          >
            <div className="rounded-2xl p-6 text-center relative h-full bg-[#4C12BF]">
              {/* Default State */}
              <div className={`transition-opacity duration-700 ${clickedCard === "AI Automation" ? "opacity-0" : "group-hover:opacity-0"}`}>
                <div className="flex justify-center mb-6">
                  <img
                    className=""
                    src={Frame || "/placeholder.svg"}
              ...
              <div
                className={`absolute inset-0 px-6 py-3 transition-opacity duration-700 
              rounded-2xl bg-gradient-to-t from-[#160043] to-[#4C12BF] ${clickedCard === "AI Automation" ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto"}`}
              >
                <div className="flex justify-center mb6">
                  <img
                    className="w-16 h-16"
