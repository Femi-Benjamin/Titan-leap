...
//         {/* Service Cards Grid */}
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 xl:gap-16 gap-6 mb-16">
...
//                 </p>
//                 <button className="w-full bg-[#FED65E] text-purple-900 font-semibold py-3 px-6
