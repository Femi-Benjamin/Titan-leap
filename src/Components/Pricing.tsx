...
const PricingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#b8a4ff] via-[#4C12BF] to-[#160043] font-sans pb-0 overflow-x-hidden">
      ...
      {/* Gift Section */}
      <div className="bg-gradient-to-b from-[#4C12BF] to-[#3d0f99] pt-20 px-4 relative">
        <div className="max-w-6xl mx-auto">
          {/* Purple rounded container */}
          <div className="bg-[#4a1b9e] rounded-tr-4xl rounded-tl-4xl px-8 md:px-16 py-16 relative overflow-visible">
            {/* Gift Image - positioned at top center, overlapping the container */}
            <motion.div
            ...
            >
              <div className="w-32 h-32 md:w-40 md:h-40">
                {/* Using gift.png placeholder - replace with actual image */}
            ...
            <motion.div
              ...
              className="text-center space-y-6 pt-12 md:pt-8"
            >
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                Get a free Growth Readiness Audit
              </h2>
              <p className="text-[#FED65E] text-lg md:text-xl lg:text-2xl max-w-4xl mx-auto font-medium">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="bg-[#FED65E] text-[#4a1b9e] px-16 py-5 w-full rounded-full font-bold text-xl hover:bg-[#ffe187] transition-all shadow-lg inline-flex items-center gap-3 mt-8"
              >
      ...
      <div className="bg-gradient-to-b from-[#3d0f99] to-[#160043] px-4">
        <div className="max-w-7xl mx-auto">
          <h3 className="text-white text-3xl md:text-4xl font-bold pb-8">
            Key Features
          </h3>
