...
export default function VideoHero() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 bg-gray300 bg-opacity-10"></div>
      {/* Content */}
      <div className="relative z-20 flex flex-col justify-end min-h-screen pb-8 md:pb-16 lg:pb-24 px-8 md:px-16 lg:px-24">
        <div className="max-w-2xl">
          <h1 className="text-neutral-700 text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6 drop-shadow-xl">
            <div>Innovate. Elevate.</div>
            <div className="text-6xl md:text-7xl lg:text-8xl">Succeed.</div>
          </h1>

          <p className="text-neutral-700 text-lg md:text-xl mb-8 leading-relaxed max-w-xl drop-shadow-xl">
            Next-level content, ads, and automation — We do the work, while you
            recharge and scale.
          </p>

          <div className="flex flex-col sm:flex-row gap-4">
            <button className="bg-[#FED65E] text-[#4C12BF] hover:bg-[#4C12BF] text-[20px] hover:text-[#FED65E] px-10 py-2 rounded-xl font-semibold cursor-pointer transition-colors duration-200 shadow-xl">
              {"Let's Talk"}
            </button>
            <button className="border-2 border-[#FED65E] text-[#FED65E] hover:bg-[#FED65E] text-[20px] hover:text-[#4C12BF] hover:border-[#4C12BF] bg-[#4C12BF] bg-opacity-80 px-4 py-2 rounded-xl font-semibold hover:bg-opacity-100 transition-all duration-200 cursor-pointer shadow-xl">
              See our work
            </button>
          </div>
        </div>
